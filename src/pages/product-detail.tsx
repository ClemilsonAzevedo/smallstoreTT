...
export function ProductDetail() {
	return (
		<section className='space-y-8'>
			...
			<div className='w-full h-[327px] bg-zinc-200 p-2 rounded-lg'>
				<img
			...
			<div className='space-y-3 flex justify-center flex-col items-center'>
				<p className='text-justify text-xs'>
					...
					power-packed performance and most extended battery life in a MacBook.
					An everyday computer with the maximal utility for a wide range of
					tasks, it creates an unparalleled and impressive laptop experience so
					practically perfect, smooth-as-butter, and user-friendly that you wont
					be able to find any faults even if you want to.
				</p>
				<div>
					...
					<ul className='text-xs space-y-2'>
						...
						<li>
							400 nits brightness, Wide color (P3) and True Tone technology One
							external display with up to 6K resolution at 60Hz Thunderbolt 3
